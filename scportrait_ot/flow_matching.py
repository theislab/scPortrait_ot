...
class SourceConditionalFlowMatcher(ConditionalFlowMatcher):
    ...
    def sample_xt(self, x1, t, epsilon):
        ...
        [1] Improving and Generalizing Flow-Based Generative Models with minibatch optimal transport, Preprint, Tong et al.
        """
        mu_t = self.compute_mu_t(epsilon, x1, t)
        sigma_t = self.compute_sigma_t(t)
        sigma_t = pad_t_like_x(sigma_t, x1)
        return mu_t + sigma_t * epsilon
    
    def compute_conditional_flow(self, epsilon, x1, t, xt):
        """
        Compute the conditional vector field ut(x1|x0) = x1 - x0, see Eq.(15) [1].
    ...
    def sample_location_and_conditional_flow(self, 
        ...
        x1 = x1[idx_target]  # Reorder target 
        ...
        ut = self.compute_conditional_flow(eps, x1, t, xt)
